...
<style>
    ...
    .search {
        margin-right: 5px;
        /* Khoảng cách giữa ô tìm kiếm và nút tìm kiếm */
    }
</style>
                ...
                <nav>
                    <ul id="main">
                        <form action="search.php" method="GET" class="search-form">
                            <input type="text" placeholder="Search and Enter" class="search" name="keyword">
                            <button type="submit" name="tk" class="tk"></button>
                        </form>
