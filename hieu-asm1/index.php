                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="text-bg">
                              ...
                              <h1>Accessories</h1>
                              <p>Hdav asfs fafsv afsasfsa afsasd avfsavdv afa afas afsasfa afsa afsa asdasa asf asfsaf afsaf sfss asdsafsaf as fs ssfsfasfsafsfsaf safsaf afasfsffsa sf sf safsaf</p>
                              <a href="#">MUA NGAY </a> <a href="contact.php">Contact </a>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="text_img">
